...
@Component({
  selector: 'app-condi-if',
  templateUrl: './condi-if.component.html',
  styles: [
  ]
})
export class CondiIfComponent implements OnInit {
  ...
  displayExpFor(){
    ...
    let div: HTMLElement | null = document.getElementById("expIf");
